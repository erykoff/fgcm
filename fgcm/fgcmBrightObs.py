...
class FgcmBrightObs:
    ...
    def brightestObsMeanMag(self, computeSEDSlopes=False):
        """
        ...
        with multiprocessing.Manager() as manager:
            ...
            sharedDict["brightObsGrayMax"] = self.brightObsGrayMax
            ...
            pool.starmap(_brightObsWorker, inputs, chunksize=1)
            pool.close()
            pool.join()
...
def _brightObsWorker(goodStarsAndObs, sharedDict):
    """
    ...
    brightObsGrayMax = sharedDict["brightObsGrayMax"]
